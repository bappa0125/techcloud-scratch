<template>
  ...
  >
   ...
   <td class="text-xs-left pruple"> <v-btn small color="primary" @click="getResult_perStep(item.eventname)">{{item.steps_performed}}</v-btn></td>
   </template>
        ...
        desserts: [
          {
            ...
            description: 'User need to create VPC , this should not be the default VPC',
            difficulty: 'Moderate',
            area: 'Networking',
            eventname:'CreateVpc',
          ...
          },
           {
            ...
            description: 'User need to create 4 subnets, two public and two private',
            difficulty: 'Moderate',
            area: 'Networking',
          ...
          },
           {
            ...
            description: 'User need to create NAT gatway and configure the routes ',
            difficulty: 'Moderate',
            area: 'Networking',
          ...
          },
           {
            ...
            description: 'User need to create Internet Gateway and configure the routes',
            difficulty: 'Moderate',
            area: 'Networking',
